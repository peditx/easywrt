...
if [[ "$CPU_ARCH" == "x86_64" ]]; then
    DOWNLOAD_URL="https://downloads.immortalwrt.org/releases/23.05.4/targets/x86/64/immortalwrt-21.02.5-x86-64-generic-squashfs-combined.img.gz"
elif [[ "$CPU_ARCH" == "i686" ]]; then
    DOWNLOAD_URL="https://downloads.immortalwrt.org/releases/23.05.4/targets/x86/generic/immortalwrt-21.02.5-x86-generic-generic-squashfs-combined.img.gz"
else
